(() => {
  ...
  // Déclenche automatique entre 2 et 3 fois toutes les 2 secondes
  const launches = Math.floor(Math.random() * 2) + 2; // 2 ou 3 fois
  for (let i = 0; i < launches; i++) {
    setTimeout(() => manager.addConfetti(), i * 2000);
  }
